...
static const char *fonts[] = {
  ...
  "FontAwesome5FreeSolid:pixelsize=15:antialias=true:autohint=true",
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-fn", "monospace:size=13", "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
